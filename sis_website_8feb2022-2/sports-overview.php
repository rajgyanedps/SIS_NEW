...
<html lang="en">
	<head>
		...
		<title>Sports Overview - Selaqui International School</title>
		<meta name="description" content="Sports Overview of Selaqui International School. The aim to provide competitive sports and physical education.">
				...
				<div class="row">
					<div class="col-xl-9 text-justify">
						<div class="section-title-header text-center">
							<h1 class="section-title wow fadeInUp" data-wow-delay="0.2s">Sports Overview</h1>
						</div>
						<div class="team-item wow fadeInUp" data-wow-delay="0.2s">
							<div class="team-img">
								<img src="assets/images/sport_overview.jpg" alt="Boarding School India" data-toggle="tooltip" title="Boarding School India" class="img-fluid">
							</div>
						</div>
						<div class="time-countdown justify-content-center wow fadeInLeft" data-wow-delay="0.3s">
							<p>
								Sports at <strong class='goudy'>SelaQui</strong> is not just an arena for competition. It plays a much larger role of developing team spirit and sportsmanship while exploring and augmenting each child’s hidden talent, Specialization in a particular sport is highly encouraged. Sequins aim at specializing in at least two sports before they graduate.
							</p>
							<div class="team-item wow fadeInUp" data-wow-delay="0.2s">
								<div class="team-img">
									<img src="assets/images/sports_overview_small.jpg" alt="Competitive sports" data-toggle="tooltip" title="Competitive sports" class="img-fluid">
								</div>
							</div>
							<p>
								Competitive sports and physical education are important aspects of life at <strong class='goudy'>SelaQui</strong>. The school focuses on developing both physical fitness as well as skills in various sports. Sport is the lone activity which allows one to learn things outside classrooms and attributes like discipline, tolerance, humility and leadership that can only be picked up in the sports field.
							</p>
							<p>
