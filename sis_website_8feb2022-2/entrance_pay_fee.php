...
if(count($_POST)>0)
{
	...
	$Redirect_Url="https://www.selaqui.org/thanks_for_contacting.php" ;//your redirect URL where your customer will be redirected after authorisation from CCAvenue
