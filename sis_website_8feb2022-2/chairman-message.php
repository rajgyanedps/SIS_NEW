...
<html lang="en">
	<head>
		...
		<title>Chairman's Message - SelaQui International School</title>
		<meta name="description" content="A message of Chairman from SelaQui International School">
				...
				<div class="row">
					<div class="col-xl-9 text-justify">
						<div class="section-title-header text-center">
							<h1 class="section-title wow fadeInUp" data-wow-delay="0.2s">Chairman's Message</h1>
						</div>
						<div class="time-countdown justify-content-center wow fadeInLeft" data-wow-delay="0.3s">
							<div class="team-item wow fadeInUp" data-wow-delay="0.2s">
								<div class="team-img">
									<img src="assets/images/chairman.jpg" alt="Mr. Om Pathak" data-toggle="tooltip" title="Mr. Om Pathak" class="img-fluid">
								</div>
							</div>
							<p><strong>Dear friend,</strong></p>
							<p>
								<strong class='goudy'>SelaQui</strong>, a leading International School at Dehradun, offers high quality academics and competitive excellence in sports, in addition to holistic development. Crafting outstanding humans; winners in academics, sports or both.
							</p>
							<p>	Consequent upon changes in ITT JEE, effective 2013, the focus is back on the school, away from the standalone coaching & test-prep centers. Being one of the most reputed and established <a class="linkforseo" href="https://www.selaqui.org/">boarding school in India.</a> <br>
								For Students of Commerce or Humanities also, <strong class='goudy'>SelaQui</strong> offers GURUKUL - CCE, A TEST prep program for admission to eminent institutes offering undergraduate programs in law, accountancy and management. It also offer high quality pastoral life, where students groom and develop; spiritually, intellectually, academically and physically.
							</p>
							<p>
								Excellence and career in Sports like Cricket, Football and Tennis, is yet another opportunity for the gen-next. Families and students wishing to pursue a career in sports without effecting academics can now joing the ARJUNA program at <strong class='goudy'>SelaQui</strong> that prepares them for participation in national and international arena in Cricket, Football or Tennis.
							</p>
							<p>
								This website will give you insight as to how do we wish to achieve it all, together with you; for you ward.
							</p>
							<p>
								<strong class="text-green">Om Pathak</strong>
							</p>
						</div>
					</div>
					<div class="col-xl-3">
