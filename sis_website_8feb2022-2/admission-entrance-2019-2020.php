          ...
          <div class="col-lg-12">
            <div class="subscribe-inner wow fadeInDown" data-wow-delay="0.3s">		<img src="assets/images/sis_logo_test_w.png" alt="Sela Qui logo">                
			   ...
			   <h2 class="subscribe-title">7500/.</h2>	
				...
				<form class="text-center" action="entrance_pay_fee.php" method="post"> 
...
<input type="hidden" name="billing_cust_address" value="<?php echo $exam_center ?>"><!--Pass Customer Full Address-->
<input type="hidden" name="billing_cust_country" value="<?php echo $classname?>"> <!--Pass Customer Country -->
