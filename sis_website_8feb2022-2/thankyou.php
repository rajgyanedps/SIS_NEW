...
<title>Thank You | Selaqui International School</title>

<?php include('include/class.php'); ?>
<!-- Event snippet for FI - Contact Us conversion page -->
<script>
  gtag('event', 'conversion', {'send_to': 'AW-1040837567/9iUICPH8tqoBEL_Xp_AD'});
</script>
<script>
					...
					<div class="row justify-content-md-center">
						<div class="col-md-10 col-lg-7">
							<div class="subscribe-inner wow fadeInDown" data-wow-delay="0.3s">			 
								<h2 class="subscribe-title">Your Enquiry has been submitted successfully</h2>
								<p class="wow fadeInDown" data-wow-delay="0.2s">We will get back to you shortly</p>
							</div>
						</div>
					</div>
				</div>
