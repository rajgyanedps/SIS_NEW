...
<html lang="en">
	<head>
		...
		<title>Dispersal - Selaqui International School Dehradun</title>
		<meta name="description" content="Dispersal - Selaqui International School Dehradun">
				...
				<div class="row">
					<div class="col-xl-9 text-justify">
						<div class="section-title-header text-center">
							<h1 class="section-title wow fadeInUp" data-wow-delay="0.2s">Dispersal</h1>
						</div>
						<div class="time-countdown justify-content-center wow fadeInLeft" data-wow-delay="0.3s">
							<p>
								<strong>Form Comming Soon !</strong>
							</p>
						</div>
					</div>
					<div class="col-xl-3">
