...
if(count($_POST)>0)
{
	...
	$Redirect_Url="https://www.selaqui.org/thankyou_for_registration.php" ;//your redirect URL where your customer will be redirected after authorisation from CCAvenue
