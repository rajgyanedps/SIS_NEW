...
<html lang="en">
   <head>
      ...
      <title>Admission Entrance Exam 2020-21</title>
   ...
   <body id="other_page">
         ...
         <div class="loader_mail">
            <div class="loaderTC_mail">
               <div class="content_mail">
                              ...
                              <div class="row justify-content-md-center">
                                 <div class="col-lg-12">
                                    <div class="subscribe-inner wow fadeInDown" data-wow-delay="0.3s">
                                       <img src="assets/images/sis_logo_test_w.png" alt="Sela Qui logo">
                                       <p class="wow fadeInDown" data-wow-delay="0.2s"> Thanks for filling your details </p>
                                       ...
                                       <form class="text-center" action="pay_fee.php" method="post">
                                          ...
                                          <!--<input type="hidden" name="lastid" value="<?php echo $studentid?>">
                                             ...
                                             <input type="hidden" name="amounts" value="<?php echo $amt?>"> 
                                             <input type="hidden" name="billing_cust_name" value="<?php echo $uname?>">
                                             ...
                                             <input type="hidden" name="billing_cust_tel" value="<?php echo $pno?>">
                                          ...
                                          <a href="https://smarthubeducation.hdfcbank.com/SmartFees/Landing.action?instId=4980" class="btn btn-common" target="_blank">Pay Now </a>
                                       </form>
                                    </div>
                                 </div>
                              </div>
                  ...
                  <div> <a href="javascript:void(0)" class="close" onclick="return ClosePopUP();">X</a> </div>
               </div>
            </div>
         </div>
      </div>
      ...
      <noscript>
         <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-N5N3WMT"
            ...
            <div class="row">
               <div class="col-xl-9 text-justify">
                  <div class="section-title-header text-center">
                     <h1 class="section-title wow fadeInUp" data-wow-delay="0.2s">Admission Entrance Exam 2020-21</h1>
                  </div>
                  ...
                  <div style="color: green;" align="center" >
                     <? //echo $message;?>
                     <a href="#" id="ABC" onclick="OpenPopUP();"></a>
                  </div>
                                 ...
                                 <div class="col-lg-6 form-line">
                                    <div class="form-group">
                                       ...
                                       <select class="form-control"  name="classname" id="classname">
                                          ...
                                          <option value="XI" <?php if($classname=="XI"){?>selected="selected"<?php } ?>>XI</option>
                                    ...
                                    <div class="row">
                                       <div class="col-lg-6">
                                          <div class="form-group text-right">
                                             ...
                                             <img src="captcha_code_file.php?rand=<?php echo rand(); ?>" id='captchaimg' class="img-fluid" style="height:30px;" alt="Captcha" /> <a href='javascript: refreshCaptcha();' style="font-size:20px;" class="text-success"><strong> <i class="fa fa-refresh" aria-hidden="true"></i></strong></a> 
                                          </div>
                                       </div>
                                       <div class="col-lg-6">
                                          <div class="form-group">
