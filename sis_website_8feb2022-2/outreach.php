...
<html lang="en">
	<head>
		...
		<title>Outreach Programme - Selaqui International School</title>
		<meta name="description" content="Know all about Outreach Programme of Selaqui International School.">
				...
				<div class="row">
					<div class="col-xl-9 text-justify">
						<div class="section-title-header text-center">
							<h1 class="section-title wow fadeInUp" data-wow-delay="0.2s">Outreach Programme</h1>
						</div>
						<div class="team-item wow fadeInUp" data-wow-delay="0.2s">
							<div class="team-img">
								<img src="assets/images/outreach.jpg" alt="Best Boarding Schools India" data-toggle="tooltip" title="Best Boarding Schools India" class="img-fluid">
							</div>
						</div>
						<div class="time-countdown justify-content-center wow fadeInLeft" data-wow-delay="0.3s">
							<p>
								<strong>Aim and Mission</strong>
							</p>
							<p>
								Character development in its broader sense is also about developing the spirit of giving back to the community that one is a part of. To inculcate this sense of greater good and sense of belonging, every <strong class='goudy'>SeQuin</strong> is involved in the Values-in-Action Programme that have see them live out the values of respect, care and empathy, and contributing in various ways to the community at large. According to the school policy, every child and staff member will devote at least 20 hours of selfless service in a year working with their immediate community on health, hygiene, cleanliness, education and rural development. Besides this every member will work for at least four days in a year in the villages adopted by us. The Community Outreach Program gives students the opportunity to get involved in community service on a regular basis Like most community outreach projects, it requires a long-term commitment on the behalf of everyone involved. 
							</p>
							<p>
								<strong>Outreach Programmes:</strong>
							</p>
							<ol>
								<li>
									It involves working with the immediate community in the field of education, health and cleanliness. The children work in schools adopted by us to provide sporting, infrastructural and skill development aid. They are also involved in language and math classes. The School doctor and students provide health and hygiene tips to them.
								</li>
								<li>
									The School also works with an orphanage and an old age home in <strong class='goudy'>SelaQui</strong> to sensitize students and inculcate respect, empathy and care among them.
								</li>
								<li>
									The Rural programme encourages <strong class='goudy'>SeQuins</strong> to work for at least four days in a year in a village about 20 Kms from the school on water harvesting, bio diversity and agriculture with the local population. This helps students in understanding the concepts that they are taught in class better and associating the same with real life experience. Students also work on projects of building small infrastructure for local population.
								</li>
							</ol>
						</div>
					</div>
