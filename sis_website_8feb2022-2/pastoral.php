...
<html lang="en">
	<head>
		...
		<title>Pastoral Care at Selaqui International School</title>
		<meta name="description" content="Know all about pastoral life at Selaqui International School.">
				...
				<div class="row">
					<div class="col-xl-9 text-justify">
						<div class="section-title-header text-center">
							<h1 class="section-title wow fadeInUp" data-wow-delay="0.2s">Pastoral Care</h1>
						</div>
						<div class="team-item wow fadeInUp" data-wow-delay="0.2s">
							<div class="team-img">
								<img src="assets/images/pastoral_care.jpg" alt="Best Residential Schools India" data-toggle="tooltip" title="Best Residential Schools India" class="img-fluid">
							</div>
						</div>
						<div class="time-countdown justify-content-center wow fadeInLeft" data-wow-delay="0.3s">
							<div class="team-item wow fadeInUp" data-wow-delay="0.2s">
								<div class="team-img">
									<img src="assets/images/pastoral.png" alt="Best Residential Schools India" data-toggle="tooltip" title="Best Residential Schools India" class="img-fluid">
								</div>
							</div>
							<p>
							...
							<div class="team-item wow fadeInUp" data-wow-delay="0.2s">
								<div class="team-img">
									<img src="assets/images/pastoral1.png" alt="Best Residential Schools India" data-toggle="tooltip" title="Best Residential Schools India" class="img-fluid">
								</div>
							</div>
							<p>
							...
							<p>
								At <strong class='goudy'>SelaQui</strong> students are encouraged to lead and shoulder responsibilities as well as develop a healthy competition among themselves. Inter – House competitions in sports and other activities are an important part of this learning process. The House Captain and House Vice – Captain helps the Housemaster in running the House smoothly.
							</p>
							<p>
								Every House has a House Council headed by Housemasters to look into the affairs of the House. They take important decisions including awarding of House Colours to students who have contributed significantly to the success of the House in the academic year.
							</p>
						</div>
					</div>
					<div class="col-xl-3">
