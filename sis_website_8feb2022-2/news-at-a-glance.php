...
<html lang="en">
	<head>
		...
		<title>News at a Glance - Selaqui International School Dehradun</title>
		<meta name="description" content="News at a Glance - Selaqui International School Dehradun">
				...
				<div class="row">
					<div class="col-xl-9 text-justify">
						<div class="section-title-header text-center">
							<h1 class="section-title wow fadeInUp" data-wow-delay="0.2s">News at a Glance</h1>
						</div>
						<div class="team-item wow fadeInUp" data-wow-delay="0.2s">
							<div class="team-img">
								<img src="assets/images/news_at_a_glance.jpg" alt="Best Boarding Schools India" class="img-fluid" data-toggle="tooltip" title="Best Boarding Schools India">
							</div>
						</div>
						<?php 
						...
						<div class="time-countdown justify-content-center wow fadeInLeft" data-wow-delay="0.3s">
							<? if($re['eFile']=='Aaryaman2.jpg'){ ?>
							<div class="team-item wow fadeInUp" data-wow-delay="0.2s">
								<div class="team-img">
									<img src="webadmin/upload/<?php echo $re['eFile']; ?>" alt="<?php echo ucwords(strtolower($re['heading'])); ?>" data-toggle="tooltip" title="<?php echo ucwords(strtolower($re['heading'])); ?>" width="200" class="img-fluid">
								</div>
							</div>
							<? } else{ ?>
							<div class="team-item wow fadeInUp" data-wow-delay="0.2s">
							...
							<? } ?>
							<p>
								<strong class="text-green"><?php echo $re['heading']; ?></strong>
							</p>
							<p>
								<?php echo $re['detail']; ?>
							</p>
							<p class="text-right">
								<a href="Gallery/gallery.asp" target="_blank" class="btn btn-common">View more...</a>
							</p>
						</div>
